  ...
  <body><a href="https://github.com/notifyjs/notifyjs"><img style="position: absolute; top: 0; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_green_007200.png" alt="Fork me on GitHub"></a>
    <div class="main container">
      ...
      <div class="eight columns summary">
        ...
        </p><img src="img/pointer.png" class="demo-mouse">
      </div>
      <div class="eight columns">
        <h3>Download</h3>
        <p>Download Notify.js including the pre-made <code>bootstrap</code> notification style:<br>
          <p><a href="//rawgit.com/notifyjs/notifyjs/master/dist/notify.js" data-download data-filename="notify.js">
              <button>Download notify.js</button></a><a href="//rawgit.com/notifyjs/notifyjs/master/dist/notify.js" data-minify-download data-filename="notify.min.js">
